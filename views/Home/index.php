    ...
    <header class="site-header">
        <div class="container-fluid">
            ...
            <a href="#" class="site-logo">
                <img class="hidden-md-down" src="<?php ruta("img/logo-2.png") ?>" alt="">
                <img class="hidden-lg-up" src="<?php ruta("img/logo-2-mob.png") ?>" alt="">
            </a>
                                ...
                                <div class="dropdown-menu-notif-list">
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            ...
                                            <img src="<?php ruta("img/photo-64-1.jpg") ?>" alt="">
                                        </div>
                                        <div class="dot"></div>
                                    ...
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="<?php ruta("img/photo-64-2.jpg") ?>" alt="">
                                        </div>
                                        <div class="dot"></div>
                                    ...
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="<?php ruta("img/photo-64-4.jpg") ?>" alt="">
                                        </div>
